...
const conferenceModel = require("../models/login.model.js");
...
exports.beejaMgrLogin = (req, res) => {
  ...
  conferenceModel.beejaLogin(loginemp, (err, data) => {
  console.log(data);
      if (err) {
        res.json(err);
      } else if (data["sts"] === "1") {
